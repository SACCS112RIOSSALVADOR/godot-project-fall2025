...
func new_game():
	...
	$HUD.get_node("VBoxContainer").hide()
	$HUD.get_node("Pause").show()
...
"Added pause game function"

func pause_game():
	game_running = false
	get_tree().paused = true
	$HUD.get_node("VBoxContainer").show()  # Show resume/restart/menu panel
	$HUD.get_node("Pause").hide()          # Hide the pause button
...
func resume_game():
	...
	$HUD.get_node("VBoxContainer").hide()  # Hide the menu
	$HUD.get_node("Pause").show()          # Show the pause button again
...
func check_game_over():
	for i in active_piece:
		if not is_free(i + cur_pos):
			...
			$HUD.get_node("VBoxContainer").show()
			$HUD.get_node("Pause").hide()
			game_running = false
